...
Weapons.prototype = {
    ...
    launchFire : function() {
        if (this.canFire) {
            ...
            var renderHeight = this.Player.game.scene.getEngine().getRenderHeight(true);
        ...
        newRocket.registerAfterRender(function(){
            ...
            if(!meshFound || meshFound.distance < 10){
                ...
                if(meshFound.pickedMesh){
                    ...
                    var explosionRadius = BABYLON.Mesh.CreateSphere("sphere", 5.0, 20, scene);
                    ...
                    explosionRadius.material = new BABYLON.StandardMaterial("textureExplosion", scene);
